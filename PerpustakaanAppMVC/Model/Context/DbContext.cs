    ...
    public class DbContext : IDisposable
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"D:\KULIAH\SEM-3\PEMROGRAMAN LANJUT\22.11.4852\22.11.4852\p11\p11\Operasi CRUD MVC Part #2\Operasi CRUD MVC Part #2\PerpustakaanAppMVC\Database\DbPerpustakaan.db";
